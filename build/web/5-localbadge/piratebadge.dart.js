...
$.Z=z
z=J.X(z)
H.J(new W.O(0,z.Q,z.a,W.V(A.M()),z.b),[H.N(z,0)]).Y()
A.Qx(A.P())},"$0","KW",0,0,1],
...
KL:[function(a){A.Qx(A.ly(null,null))},"$1","M",2,0,20],
Qx:function(a){var z
if(a==null)return
z=document.querySelector("#badgeName")
z.textContent=J.FN(a.Q)===!0?"":H.d(a.Q)+" the "+H.d(a.a)
window.localStorage.setItem("pirateName","{ \"f\": \""+H.d(a.Q)+"\", \"a\": \""+H.d(a.a)+"\" } ")},
P:function(){var z,y
...
J.FN=function(a){return J.W(a).gl0(a)}

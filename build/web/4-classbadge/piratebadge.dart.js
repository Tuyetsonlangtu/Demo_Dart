...
for(z=J.W(y),v=J.W(x),u=0;u<z.gv(y);++u){if(u>=y.length)return H.e(y,u)
...
static:{C3:function(a){return new P.S(null,null,!1,null,null,a)},D:function(a,b,c){return new P.S(null,null,!0,a,b,"Value not in range")},TE:function(a,b,c,d,e){return new P.S(b,c,!0,a,d,"Invalid value")},jB:function(a,b,c,d,e,f){if(a<0||a>c)throw H.b(P.TE(a,0,c,"start",f))
...
"^":"",
Iq:[function(){var z=J.T(document.querySelector("#inputName"))
H.J(new W.O(0,z.Q,z.a,W.V(A.L()),z.b),[H.N(z,0)]).Y()
z=document.querySelector("#generateButton")
$.Z=z
z=J.X(z)
H.J(new W.O(0,z.Q,z.a,W.V(A.M()),z.b),[H.N(z,0)]).Y()},"$0","KW",0,0,1],
U:[function(a){var z,y,x,w
z=H.Go(J.G0(a),"$isMi").value
y=A.P(null,z)
x=document.querySelector("#badgeName")
w=y.Q
x.textContent=w.length===0?"":w+" the "+y.a
y=J.rr(z)
x=$.Z
if(y.length===0){J.zL(x,!1)
x.textContent="Aye! Gimme a name!"}else{J.zL(x,!0)
x.textContent="Arrr! Write yer name!"}},"$1","L",2,0,20],
KL:[function(a){var z,y,x
z=A.P(null,null)
y=document.querySelector("#badgeName")
x=z.Q
y.textContent=x.length===0?"":x+" the "+z.a},"$1","M",2,0,20],
QQ:{
"^":"a;Q,a",
X:function(a){var z=this.Q
return z.length===0?"":z+" the "+this.a},
iF:function(a,b){var z,y
if(b==null){z=$.Y()
y=$.VY().j1(10)
if(y<0||y>=10)return H.e(z,y)
this.Q=z[y]}else this.Q=b
z=$.eg()
y=$.VY().j1(10)
if(y<0||y>=10)return H.e(z,y)
this.a=z[y]},
static:{P:function(a,b){var z=new A.QQ(null,null)
z.iF(a,b)
return z}}}},1],]
...
J.kE=function(a,b){return J.W(a).tg(a,b)}
...
I.$lazy($,"names","XR","Y",function(){return["Anne","Mary","Jack","Morgan","Roger","Bill","Ragnar","Ed","John","Jane"]})
